 ...
 * @author michael
 */
public class CDNormalizerTest extends TestCase {
    ...
    static {
        String classname = CDNormalizerTest.class.getSimpleName();
        InputStream in = CDNormalizerTest.class.getClassLoader().getResourceAsStream(classname.substring(0, classname.length() - 4).concat(".test"));
    ...
    public void testNormalize() {
        CDNormalizer instance = new CDNormalizer();
        int success = 0;
