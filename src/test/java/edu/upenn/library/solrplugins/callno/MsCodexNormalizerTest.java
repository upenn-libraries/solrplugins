 ...
 * @author michael
 */
public class MsCodexNormalizerTest extends TestCase {
    ...
    static {
        String classname = MsCodexNormalizerTest.class.getSimpleName();
        InputStream in = MsCodexNormalizerTest.class.getClassLoader().getResourceAsStream(classname.substring(0, classname.length() - 4).concat(".test"));
    ...
    public void testNormalize() {
        MsCodexNormalizer instance = new MsCodexNormalizer();
        int success = 0;
