 ...
 * @author michael
 */
public class DeweyNormalizerTest extends TestCase {
    ...
    static {
        String classname = DeweyNormalizerTest.class.getSimpleName();
        InputStream in = DeweyNormalizerTest.class.getClassLoader().getResourceAsStream(classname.substring(0, classname.length() - 4).concat(".test"));
    ...
    public void testNormalize() {
        DeweyNormalizer instance = new DeweyNormalizer();
        int success = 0;
