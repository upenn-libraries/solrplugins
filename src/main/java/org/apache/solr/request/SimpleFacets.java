...
//            }
        ...
        case FC:
          ...
          counts = DocValuesFacets.getCounts(searcher, docs, field, offset,limit, mincount, missing, sort, prefix, termFilter, fdebug, extend, targetBr, targetDoc, external, fl);
          break;
        default:
