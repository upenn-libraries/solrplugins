 ...
 * @author michael
 */
public class DVDNormalizerTest extends TestCase {
    ...
    static {
        String classname = DVDNormalizerTest.class.getSimpleName();
        InputStream in = DVDNormalizerTest.class.getClassLoader().getResourceAsStream(classname.substring(0, classname.length() - 4).concat(".test"));
    ...
    public void testNormalize() {
        DVDNormalizer instance = new DVDNormalizer();
        int success = 0;
