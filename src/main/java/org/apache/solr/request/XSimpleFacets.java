...
import edu.upenn.library.solrplugins.mod.XDocValuesFacets;
...
public class XSimpleFacets {
  ...
  public XSimpleFacets(SolrQueryRequest req,
                      DocSet docs,
                      SolrParams params) {
    ...
    if (params.getFieldBool(field, GroupParams.GROUP_FACET, false)) {
      ...
      switch (appliedFacetMethod) {
        ...
        case UIF:
          ...
          break;
        case FC:
          counts = XDocValuesFacets.getCounts(searcher, docs, field, offset,limit, mincount, missing, sort, prefix, contains, ignoreCase, fdebug);
          break;
        default:
